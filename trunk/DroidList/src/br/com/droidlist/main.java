...
public class main extends Activity implements Runnable {
   ...
   void carregaPrincipal() {
      ...
      try {
         ...
         ArrayAdapter<Lista> apLista = new ArrayAdapter<Lista>(main.this, android.R.layout.simple_spinner_item, strLista);
   ...
   void dialogoCadastraProduto(boolean botao) {
      try {
         if (botao) {
            final Dialog produto = new Dialog(main.this);
            ...
            cat.setId(9999);
            cat.setNome("Incluir Nova");
            strCategoria.add(cat);
            ArrayAdapter<Categoria> adpCategorias = new ArrayAdapter<Categoria>(main.this, android.R.layout.simple_spinner_item, strCategoria);
            ...
            spnCategorias.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
               ...
               public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                  ...
                  //Toast.makeText(DroidList.this, "id categoria "+ c.getId() + " - " + c.getNome(), Toast.LENGTH_SHORT).show();
               }
...
//                        EditText edQtde = (EditText) produto.findViewById(R.addproduto.edqtde);
                  if (!strCategoria.isEmpty() & edproduto.length() > 0) {
                     ...
                     Toast.makeText(main.this, R.string.mensagem_informa_nomeProduto, Toast.LENGTH_SHORT).show();
                  }
               }
            });
...
//                        EditText edQtde = (EditText) produto.findViewById(R.addproduto.edqtde);
   ...
   void dialogoAlteraProduto(final Produto p) {
      try {
         ...
         final ArrayAdapter<Categoria> adpCategorias = new ArrayAdapter<Categoria>(main.this, android.R.layout.simple_spinner_item, strCategoria);
         adpCategorias.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
         spnCategorias.setAdapter(adpCategorias);
         spnCategorias.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
   ...
   void dialogoCadastraCategoria(final String fonte) {
      try {
         final Dialog dialogo = new Dialog(main.this);
         ...
         btcadastrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               if (edcateg.length() > 0) {
                  ...
                  //fonte L = adiciona ao banco e na lista, B = adiciona no banco para escolha futura, M = adiciona a lista
                  if (!fonte.equals("M")) {
                     if (fonte.equals("L")) {
                        dialogoCadastraProduto(true);
                  ...
                  Toast.makeText(main.this, R.string.mensagem_informa_campoVazio, Toast.LENGTH_SHORT).show();
               }
            }
         });
         dialogo.show();
         ...
         btcadastrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               if (ed.length() > 0) {
                  ...
                  Toast.makeText(main.this, R.string.erro_cadlista, Toast.LENGTH_SHORT).show();
               }
            }
         });
...
void dialogoEscolheProduto() {
      try {
		...
		final ListAdapter la = new ArrayAdapter<Produto>(main.this, android.R.layout.simple_list_item_checked, lstProd);
         ...
         ArrayAdapter<Categoria> spla = new ArrayAdapter<Categoria>(main.this, android.R.layout.simple_spinner_item, lstCateg);
         ...
         sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1, int pos, long arg3) {
               ...
               String[] campos = new String[]{"_id"};
               int[] xml = new int[]{R.esc_produto_check.bcheck};
               lst.setAdapter(new ProdutosCursorAdapter(main.this, R.layout.esc_produto_check, db.listarProdutos(categ.getId(), lista), campos, xml));
            }
            ...
            public void onClick(View arg0) {
               try {
                  ...
                  if (!prods.produtosMarcados().isEmpty()) {
                     ...
                     Toast.makeText(main.this, R.string.mensagem_informa_produtoAdicionado, Toast.LENGTH_SHORT).show();
                     atualizaLista();
                     dialogo.dismiss();
                  } else {
                     Toast.makeText(main.this, R.string.mensagem_informa_selecionarProduto, Toast.LENGTH_SHORT).show();
                  }
               } catch (Exception e) {
      ...
      try {
         ...
         dialogo.setPositiveButton(R.string.label_sim, new OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
               ...
               db.fechaBanco();
               atualizaLista();
               Toast.makeText(main.this, R.string.mensagem_informa_bancoResetado, Toast.LENGTH_SHORT).show();
               carregaPrincipal();
            }
         });
   ...
   public void dialogoApagaCategoria() {
      try {
         ...
         ArrayAdapter<Categoria> adp = new ArrayAdapter<Categoria>(main.this, android.R.layout.simple_spinner_item, categorias);
         ...
         btExcluir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               if (c.getCount() == 0) {
                  ...
                  Toast.makeText(main.this, R.string.mensagem_informa_categoriaNaoExcluida, Toast.LENGTH_SHORT).show();
               }
            }
         });
...
public void dialogoTamanhoFont() {
      try {
         ...
         opcao.add("Media");
         opcao.add("Grande");
         ArrayAdapter<String> aStr = new ArrayAdapter<String>(main.this, android.R.layout.select_dialog_singlechoice, opcao);
   ...
   public void opcoesProduto(final Produto produto) {
      try {
         ...
         String[] itens = new String[]{
            this.getString(R.string.label_editarItem),
            this.getString(R.string.label_removerLista),
            this.getString(R.string.label_eliminaItem),
            this.getString(R.string.label_marcaItem),
   ...
   public void atualizaLista() {
      ...
      cc = new CustomCursorAdapter(main.this, R.layout.check_list, db.listarProdutos(lista), campos, xml);
      //setListAdapter(cc);
   ...
   public void enviarEmail() {
      ...
      Log.i("produtos sb", produtos.toString());

      main.this.startActivity(Intent.createChooser(emailIntent, getString(R.string.mensagem_enviar_email)));

   }

   public void sobre() {
      AlertDialog.Builder dialogo = new AlertDialog.Builder(this);
      dialogo.setTitle("DroidList");
      dialogo.setIcon(R.drawable.icon);
      dialogo.setMessage("Todos os direitos reservados! \n"
              + "Rodrigo Ferreira \n"
              + "dilcve@gmail.com \n"
              + "versao 1.0");
